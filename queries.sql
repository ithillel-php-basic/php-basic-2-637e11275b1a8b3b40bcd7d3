...
INSERT INTO projects (name, user_id) VALUES ('Learning', 7);
INSERT INTO projects (name, user_id) VALUES ('Work', 7);
...
INSERT INTO tasks (title, description, status, file_path, user_id, project_id, created_at) VALUES ('Duis ac nibh.', 'Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis.', 'done', 'Sit.mp3', 7, 3, '2023-05-06');
INSERT INTO tasks (title, description, status, file_path, user_id, project_id, created_at) VALUES ('Maecenas tincidunt lacus at velit.', 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.', 'in-progress', 'VelitEu.avi', 7, 1, '2023-04-29');
INSERT INTO tasks (title, description, status, file_path, user_id, project_id, created_at) VALUES ('Vivamus vestibulum sagittis sapien.', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam vel augue. Vestibulum rutrum rutrum neque.', 'in-progress', 'DolorVel.avi', 7, 4, '2023-05-08');
INSERT INTO tasks (title, description, status, file_path, user_id, project_id, created_at) VALUES ('Duis ac nibh.', 'Aliquam erat volutpat. In congue. Etiam justo.', 'done', 'Viverra.mp3', 7, 4, '2023-05-08');
...
INSERT INTO tasks (title, description, status, file_path, user_id, project_id, created_at) VALUES ('Donec vitae nisi.', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus.', 'in-progress', 'EleifendDonec.avi', 7, 1, '2023-05-11');
INSERT INTO tasks (title, description, status, file_path, user_id, project_id, created_at) VALUES ('Morbi quis tortor id nulla ultrices aliquet.', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.', 'backlog', 'VestibulumVelitId.jpeg', 7, 3, '2023-04-24');
INSERT INTO tasks (title, description, status, file_path, user_id, project_id, created_at) VALUES ('Duis aliquam convallis nunc.', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.', 'done', 'NonMattisPulvinar.ppt', 7, 4, '2023-05-08');
